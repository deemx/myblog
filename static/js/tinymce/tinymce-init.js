tinyMCE.init({
    mode:"textareas",
    language: 'ru',
    plugins : "autolink,lists,code,spellchecker,pagebreak,image, imagetools,layer,table,save,insertdatetime,preview,media,searchreplace,print,contextmenu,paste,directionality,fullscreen,noneditable,visualchars,nonbreaking,template",
